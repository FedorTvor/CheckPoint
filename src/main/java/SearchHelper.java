...
//                                setComp(IntComp).
//                                setParser(Str2Int).setSelector(DataType.datatype.CAR)
...
//                                setGetter(new CowLevel.YearOfCar()).
//                                setComp(StrComp).
//                                setParser(Str2Str).setSelector(DataType.datatype.CAR)
...
//                                .setComp(StrComp)
//                                .setParser(Str2Str).setSelector(DataType.datatype.BOOK)
...
//                                setComp(IntComp).
//                                setParser(Str2Int).setSelector(DataType.datatype.BOOK)
//                        ).addAction("0", "Отмена", null)
//                );
...
//                                setComp(StrComp).
//                                setParser(Str2Str).setSelector(DataType.datatype.ROOTVEGETABLE)
...
//                                setComp(IntComp).
//                                setParser(Str2Int).setSelector(DataType.datatype.ROOTVEGETABLE)
//                        ).addAction("0", "Отмена", null)
//                );
