...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        sort_menu.prelude="Выберите тип данных";
        sort_menu.addAction("1", "Автомобиль",new Menu().
        ...
        sort_menu.addAction("2", "Книга",new Menu().
        ...
        sort_menu.addAction("3", "Корнепллод", new Menu().
        ...
        sort_menu.addAction("0", "Отмена", null);
