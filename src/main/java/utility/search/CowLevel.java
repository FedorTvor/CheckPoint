package utility.search;//There is no cow level
import models.Car;
import utility.comparator.CustomComparator;
import utility.valuegetters.CompObjectByValue;
import utility.valuegetters.ValueGetter;
...
public class CowLevel{
    public static class YearOfCar extends ValueGetter<Car, Integer> {
    ...
    static void debugStuff(){
        ...
        CompObjectByValue<Car, Integer> car_comp=new CompObjectByValue<Car, Integer>(getter, comp);
